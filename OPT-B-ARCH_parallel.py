...
combinations = comb(models_list, 1)

i = 0
for voting_method in ['soft', 'hard']:  # TODO: need to test with hard as first
    ...
    break
        """
df_combinations.to_excel('/Users/nizarmichaud/PycharmProjects/ACA_Public/B_ARCH_output/combination_eval_max1.xlsx')
